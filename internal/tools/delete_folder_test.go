...
// TestDeleteFolder_MissingFolderID validates that the handler returns a tool
// error when the required folder_id parameter is missing.
func TestDeleteFolder_MissingFolderID(t *testing.T) {
	handler := NewHandleDeleteFolder(graph.RetryConfig{}, 0)
